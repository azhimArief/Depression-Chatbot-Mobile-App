        ...
        child: Row(
          children: <Widget>[
            ...
            Container(
              ...
              child: IconButton(
                  icon: Icon(Icons.send, color: Colors.blueAccent,), //Colors.green[400]
...
// Adjust font and such
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Depression Chatbot", style: TextStyle(color: Colors.blueAccent),), //Colors.green[400]
